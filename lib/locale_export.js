...
module.exports = {
    handle: function(fromLocale, toLocale, exportFile) {
        ...
        //Strings
        var fromLocaleStrings = common.parseFile(fromLocaleFilename, true),
            toLocaleStrings = common.parseFile(toLocaleFilename)
        //Options/output
        var toLocaleOptions = common.parseFile(toLocaleOptionsFilename);
            csvOutput = [];
        ...
        for (var key in fromLocaleStrings) {
            var currentString = fromLocaleStrings[key],
                translatedString = toLocaleStrings[key] || "";
